...
export default function Home() {
  return (
    <main className='select-none'>
      <h2 className='mt-8 text-4xl font-semibold text-primary md:text-6xl px-10 mx-auto text-center max-w-5xl tracking-wide font-[Poppins]'>
        Una plataforma donde llorar y palante.
      </h2>
      <div className='flex flex-col md:flex-row gap-2 md:gap-0 justify-start py-14 md:py-24 px-2 font-light items-center md:justify-center'>
        <div className='flex flex-col text-center gap-2 md:max-w-lg md:items-start'>
          <p className='text-3xl font-semibold md:text-4xl md:text-start font-[Poppins] md:max-w-md text-palette-blue'>
      ...
      <div className='flex flex-col md:flex-row-reverse justify-start py-14 md:py-24 gap-2 md:gap-0 px-2 font-light items-center md:justify-center bg-white text-gray-900'>
        <div className='flex flex-col text-center gap-2 md:max-w-lg md:items-start'>
          <p className='text-3xl font-semibold md:text-4xl md:text-start font-[Poppins]'>
            Comenta otras publicaciones
          </p>
          <p className='text-lg md:text-lg text-secondnary px-5 text-center md:max-w-md md:px-0 md:text-start text-palette-gray'>
      ...
      <div className='flex flex-col md:flex-row gap-2 md:gap-0 justify-start pt-10 md:py-24 px-2 font-light items-center md:justify-center'>
        <div className='flex flex-col text-center gap-2 md:max-w-lg md:items-start'>
          <p className='text-3xl font-semibold md:text-4xl md:text-start font-[Poppins] md:max-w-md text-palette-blue'>
            Pórtate bien
          </p>
