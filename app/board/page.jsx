          ...
          <>
            <li className='relative'>
              <Link href={`/board/${user.posts[0].id}`}>
                <button className='w-full max-w-sm px-8 py-4 bg-gray-900/70 border border-action rounded-lg shadow-sm shadow-action'>
                  ...
                  <div className='flex justify-between mt-2 items-end text-secondary font-medium'>
                    ...
                    <div className='flex flex-col items-end'>
                      ...
                      <p className='text-sm text-action-2 font-semibold'>
