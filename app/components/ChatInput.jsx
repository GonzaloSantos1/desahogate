  ...
  return (
    <>
      {!session ? (
        ...
        <form
          onSubmit={addComment}
          className='flex overflow-visible w-full text-md md:text-sm relative justify-between md:px-4 pb-2 z-50'
        >
          <div className=' w-full flex rounded-md overflow-hidden mx-2 md:mx-0'>
            ...
            <button
              ...
              className='text-palette-purple font-medium bg-gray-100 dark:bg-palette-gray disabled:text-secondary disabled:cursor-not-allowed ease-in-out pl-2 pr-6'
            >
              {!sending ? (
                <span>
                  <TbSend size={24} />
          ...
          {showEmojis && (
            <div className='absolute z-50 -top-[440px] right-2'>
              <Picker
